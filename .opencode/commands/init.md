---
description: VISION — init (inicializar proyecto)
---

Inicializa el proyecto VISION. Configura el estado, pregunta si es reverse engineering, y ofrece descargar Spec Kit y Agency Agents.
...
**Siempre pasa los flags** para evitar prompts interactivos del script (los agentes de IDE no son terminales TTY):
...
(asegúrate de que hay archivos en `refdocs/` antes de continuar; y en `source-code/` si es reverse engineering)
