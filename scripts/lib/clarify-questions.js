...
const DOMAIN_PROMPTS = {
  ...
  sprints: [
    "Analiza el Spec Kit del proyecto (epics, stories, PRD, technical-spec).",
    "Genera entre 4 y 6 preguntas de clarificacion necesarias para planificar los sprints de forma realista.",
    "Enfocate en: priorizacion de features, dependencias entre historias, velocidad esperada del equipo y criterios de done por sprint.",
  ].join(" "),
