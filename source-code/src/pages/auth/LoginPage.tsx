...
import { LucideLogIn, LucideMail, LucideLock, LucideLoader2 } from 'lucide-react';
      ...
      <div className="w-full max-w-md space-y-8 bg-white dark:bg-zinc-900 p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-zinc-800">
        <div className="text-center">
          <div className="flex justify-center">
            <div className="rounded-full bg-blue-100 dark:bg-blue-900/30 p-3">
              <LucideLogIn className="h-8 w-8 text-blue-600 dark:text-blue-400" />
            </div>
          </div>
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-zinc-400">
            Sign in to continue to FastTrack AI
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <p className="mt-6 text-center text-sm text-gray-600 dark:text-zinc-400">
            ...
            <Link to="/auth/signup" className="font-semibold text-blue-600 hover:text-blue-500 dark:text-blue-400">
              Sign up
            </Link>
          </p>
        </form>
